...
# 模型一
class NAS_Model(MetaModel):
    def __init__(self, args):
        super(NAS_Model, self).__init__(args)
        self.args = args
    ...
    def forward(self, inputs, train = True):
        ...
        estimated = self.NeuCF(
            torch.cat((first_embeds, second_embeds, third_embeds, fourth_embeds, fifth_embeds, sixth_embeds),
    ...
    def get_inputs(self, inputs):
        ...
        return firstIdx.long(), secondIdx.long(), thirdIdx.long(), fourthIdx.long(), fifthIdx.long(), sixthIdx.long()
